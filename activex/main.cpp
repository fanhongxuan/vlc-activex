...
#define COMPANY_STR "Fanhongxuan"
#define PROGRAM_STR "IPC ActiveX Plugin"
#define DESCRIPTION "ActiveX for IPC"

#define THREADING_MODEL "Apartment"
#define MISC_STATUS     "131473"

#define PROGID_STR "IPC ActiveX Plugin"
...
static void UnregisterProgID(REFCLSID rclsid, unsigned int version)
{
    ...
    TCHAR progId[sizeof(PROGID_STR)*2+32];
